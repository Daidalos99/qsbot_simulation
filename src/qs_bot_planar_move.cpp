...
#include "qs_bot/qs_bot_planar_move.h"
...
namespace gazebo
{
  ...
  void GazeboRosPlanarMove::publishOdometry(double step_time)
  {
    ...
    odom_.pose.covariance[14] = 0.001;
    odom_.pose.covariance[21] = 0.001;
    odom_.pose.covariance[28] = 0.001;
    odom_.pose.covariance[35] = 0.03;
